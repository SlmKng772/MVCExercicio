...
namespace MVCExercicio.Controllers
{
    public class InventariosController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            model.ClientesList = _context.CadCli.ToList();
            model.MaqList = _context.CadMaq.ToList();
            return View(model);
        }
        ...
        public async Task<IActionResult> Create([Bind("idInv,idCli,idMaq,Qtd")] Inventario inventario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idInv,idCli,idMaq,Qtd")] Inventario inventario)
        {
        ...
        {
          return (_context.Inventario?.Any(e => e.idInv == id)).GetValueOrDefault();
        }
    }
}
